...
(function(vue) {
  ...
  const PagesCoverCover = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$5], ["__file", "E:/uniapp_ai/appAI/pages/cover/cover.vue"]]);
  const _sfc_main$5 = {
    __name: "index",
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__file", "E:/uniapp_ai/appAI/pages/index/index.vue"]]);
  ...
  const PagesCallCall = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["__file", "E:/uniapp_ai/appAI/pages/call/call.vue"]]);
  const _sfc_main$3 = {};
  ...
  const PagesLogsLogs = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["__file", "E:/uniapp_ai/appAI/pages/logs/logs.vue"]]);
  const _sfc_main$2 = {
    data() {
      return {
        menuItems: [
  ...
  const PagesSettingsSettings = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__file", "E:/uniapp_ai/appAI/pages/settings/settings.vue"]]);
  const _sfc_main$1 = {
    data() {
      return {
        deviceList: [],
    ...
    methods: {
      ...
      initialBluetooth() {
        uni.openBluetoothAdapter({
          success: (res) => {
            formatAppLog("log", "at Component/bluetooth.vue:115", "初始化蓝牙成功", res);
          },
          fail: (err) => {
            formatAppLog("log", "at Component/bluetooth.vue:118", "初始化蓝牙失败", err);
          }
        });
      },
      // 搜索蓝牙设备
      seekDevice() {
        uni.startBluetoothDevicesDiscovery({
          ...
          success: (res) => {
            formatAppLog("log", "at Component/bluetooth.vue:128", "开始搜索设备", res);
            this.monitorDevice();
          },
          fail: (err) => {
            formatAppLog("log", "at Component/bluetooth.vue:132", "搜索失败", err);
          }
        });
      },
      // 监听搜索到的设备
      monitorDevice() {
        uni.onBluetoothDeviceFound((res) => {
          formatAppLog("log", "at Component/bluetooth.vue:140", "发现设备", res);
      ...
      stopSeekDevice() {
        uni.stopBluetoothDevicesDiscovery({
          success: () => {
            formatAppLog("log", "at Component/bluetooth.vue:153", "停止搜索成功");
          }
        });
      },
      // 连接设备
      linkDevice(deviceId) {
        ...
        uni.createBLEConnection({
          deviceId,
          success: () => {
            formatAppLog("log", "at Component/bluetooth.vue:164", "连接成功");
            uni.showToast({ title: "连接成功" });
            this.getBLEService();
          },
          fail: (err) => {
            formatAppLog("log", "at Component/bluetooth.vue:169", "连接失败", err);
          }
        });
      },
      // 获取服务
          ...
          success: (res) => {
            res.services.forEach((item) => {
              if (item.uuid.toUpperCase() === "12345678-1234-1234-1234-1234567890AB") {
                ...
                formatAppLog("log", "at Component/bluetooth.vue:182", "找到目标服务");
      ...
      confirmWifiInput() {
        ...
        formatAppLog("log", "at Component/bluetooth.vue:227", "已保存WiFi信息：", this.wifiName, this.wifiPassword);
      },
      // 发送wifi信息数据给esp32
      sendDataDevice() {
        if (!this.wifiName) {
        ...
        uni.writeBLECharacteristicValue({
          ...
          success: () => {
            ...
            formatAppLog("log", "at Component/bluetooth.vue:255", "发送内容:", data);
          },
          fail: (err) => {
            uni.showToast({ title: "发送失败", icon: "none" });
            formatAppLog("log", "at Component/bluetooth.vue:259", "发送失败", err);
          }
        });
      },
      // ArrayBuffer转字符串
    ...
    mounted() {
      uni.onBLECharacteristicValueChange((res) => {
        ...
        formatAppLog("log", "at Component/bluetooth.vue:279", "ESP32返回:", msg);
        if (msg === "wifi_success")
          uni.showToast({ title: "配网成功" });
        if (msg === "wifi_fail")
          uni.showToast({ title: "配网失败" });
      });
    }
  };
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
      vue.createElementVNode("view", { class: "menu-list-BLE" }, [
        (vue.openBlock(true), vue.createElementBlock(
          vue.Fragment,
          null,
          vue.renderList($data.menuItems, (item, index) => {
            return vue.openBlock(), vue.createElementBlock("view", {
              ...
              vue.createElementVNode("text", { class: "menu-arrow-BLE" }, "›")
            ], 8, ["onClick"]);
          }),
          128
          /* KEYED_FRAGMENT */
      ...
      $data.showWifiModal ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 0,
        class: "modal-overlay",
        onClick: _cache[5] || (_cache[5] = (...args) => $options.closeWifiModal && $options.closeWifiModal(...args))
      }, [
        vue.createElementVNode("view", {
          class: "modal-box",
          ...
          vue.createElementVNode("text", { class: "modal-title" }, "输入 WiFi 信息"),
          vue.withDirectives(vue.createElementVNode(
            "input",
            {
              "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => $data.wifiName = $event),
          ...
          vue.createElementVNode("view", { class: "modal-actions" }, [
            vue.createElementVNode("button", {
              class: "btn-cancel",
              onClick: _cache[2] || (_cache[2] = (...args) => $options.closeWifiModal && $options.closeWifiModal(...args))
            }, "取消"),
            vue.createElementVNode("button", {
              class: "btn-confirm",
              onClick: _cache[3] || (_cache[3] = (...args) => $options.confirmWifiInput && $options.confirmWifiInput(...args))
            }, "确定")
          ])
        ])
      ])) : vue.createCommentVNode("v-if", true),
  ...
  const ComponentBluetooth = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__file", "E:/uniapp_ai/appAI/Component/bluetooth.vue"]]);
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "E:/uniapp_ai/appAI/App.vue"]]);
  function createApp() {
